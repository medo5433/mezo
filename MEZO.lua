...
ControllerAll = false
local ListSudos ={Sudo_Id,1001132193,00000000000000,11111111111111}  
...
msg.Name_Controller = 'المبرمج بارلو'
msg.The_Controller = 1
elseif tonumber(msg.sender.user_id) == 00000000000000 then
msg.Name_Controller = 'مبرمج السورس'
msg.The_Controller = 1
elseif tonumber(msg.sender.user_id) == 11111111111111 then
msg.Name_Controller = 'مبرمج السورس'
msg.The_Controller = 1
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/bar_lo0o0o0o0o'}, },}}
...
--download('https://raw.githubusercontent.com/M2007A/JEKA/master/MEZO.lua','MEZO.lua')
...
NamesBot = (Redis:get(MEZO.."MEZO:Name:Bot") or "اللورد")
...
{
{text = Jabwa, url = 't.me/bar_lo0o0o0o0o'}, 
},
{
{text = Grosupsw, url = 't.me/bar_lo0o0o0o0o'}, 
},
{
{text = Usperos, url = 't.me/bar_lo0o0o0o0o'}, 
},
}
...
if Controller(msg_chat_id,UserId_Info.id) == 'المبرمج بارلو' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ● عذرا لا تستطيع حظر عام『 "..Controller(msg_chat_id,UserId_Info.id).." 』*","md",true)  
end
...
if Controller(msg_chat_id,Message_Reply.sender.user_id) == 'المبرمج بارلو' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ● عذرا لا تستطيع حظر عام『 "..Controller(msg_chat_id,Message_Reply.sender.user_id).." 』*","md",true)  
end
...
if Controller(msg_chat_id,UserId) == 'المبرمج بارلو' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n*  ● عذرا لا تستطيع كتم عام『 "..Controller(msg_chat_id,UserId).." 』*","md",true)  
end
if Controller(msg_chat_id,UserId) == 'مبرمج السورس' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n*  ● عذرا لا تستطيع كتم عام『 "..Controller(msg_chat_id,UserId).." 』*","md",true)  
...
data = {
{
{text = '᪣ 𝘉𝘈𝘙𝘓𝘖 • 𝘚𝘖𝘜𝘙𝘊𝘌 ᪣', url = 't.me/bar_lo0o0o0o0o'}, 
},
}
}
...
keyboard.inline_keyboard = {
{
{text = '᪣ 𝘉𝘈𝘙𝘓𝘖 • 𝘚𝘖𝘜𝘙𝘊𝘌 ᪣', url = "https://t.me/bar_lo0o0o0o0o"}
},
}
...
photo = "https://t.me/jdndnhdb/4"
local T =[[
⦑ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ sᴏᴜʀᴄᴇ ᴇʟ ʟᴏʀᴅ⦒ 
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '⧫ 𝘋𝘌𝘝 • 𝘉𝘈𝘙𝘓𝘖 ⧫', url = "https://t.me/bar_lo0o0"},{text = 'ᴛɪɢᴇʀ ᴇʟѕᴏɢᴇʀ', url = "https://t.me/DV_ABDO"}
},
{
{text = '⧫ 𝘉𝘈𝘙𝘓𝘖 • 𝘉𝘖𝘛 ⧫', url = "https://t.me/barlo0o_bot"},{text = '˹  ᴛɪɢᴇʀ ᴇʟᴛᴇʟʏ. 𓌗', url = "https://t.me/bar_lo0o0o0o0o"}
},
{
{text = '᪣ ??𝘈𝘙𝘓𝘖 • 𝘚𝘖𝘜𝘙𝘊𝘌 ᪣', url = "https://t.me/bar_lo0o0o0o0o"}
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(T).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
elseif text == 'Barlo' or text == 'بارلو' or text == 'مبرمج السورس ' then
photo = "https://t.me/bar_lo0o0"
local Name = 'ᴘʀᴏɢʀᴀᴍᴍᴇʀ ⧫ 𝘉𝘈𝘙𝘓𝘖 ⧫ \n ᴛᴏ ᴄᴏᴍᴍụɴɪᴄᴀᴛᴇ ᴛᴏɢᴇᴛʜᴇʀ, \nғᴏʟʟᴏᴡ ᴛʜᴇ ʙụᴛᴛᴏɴѕ ʟᴏᴡᴇʀ 𝅘𝅥𝅯 '
keyboard = {} 
keyboard.inline_keyboard = {
{
...
elseif text == 'عبدلله' or text == 'عبدو' or text == 'مطور السورس' then
photo = "https://t.me/DV_ABDO"
local Name = 'ᴘʀᴏɢʀᴀᴍᴍᴇʀ ᴛɪɢᴇʀ ᴇʟѕᴏɢᴇʀ ⁦. 𓌗 \n ᴛᴏ ᴄᴏᴍᴍụɴɪᴄᴀᴛᴇ ᴛᴏɢᴇᴛʜᴇʀ, \nғᴏʟʟᴏᴡ ᴛʜᴇ ʙụᴛᴛᴏɴѕ ʟᴏᴡᴇʀ 𝅘𝅥𝅯 '
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '˹  𝑻𝒊𝒈𝒆𝒓 | 𝙴𝙻𝚂𝙾𝙶𝙴𝚁 ⁦. 𓌗', url = "https://t.me/DV_ABDO"}
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(Name).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
elseif text == 'اسلام' or text == 'اسلام دهب' or text == 'عم التيلي' then
photo = "https://t.me/ESdAk"
local Name = 'ᴘʀᴏɢʀᴀᴍᴍᴇʀ ɪѕʟᴀᴍ ᴅᴀʜᴀʙ ᴄᴏᴍᴍụɴɪᴄᴀᴛᴇ ᴛᴏɢᴇᴛʜᴇʀ, \nғᴏʟʟᴏᴡ ᴛʜᴇ ʙụᴛᴛᴏɴѕ ʟᴏᴡᴇʀ 𝅘𝅥𝅯 '
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '˹   𝒊𝒔𝒍𝒂𝒎 𝒅𝒂𝒉𝒂𝒃 ⁦. 𓌗', url = "https://t.me/ESdAk"}
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(Name).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
return LuaTele.sendText(msg_chat_id,msg_id,'● اليك قسم الالعاب من سورس اللورد ●',"md",false, false, false, false, reply_markup)
end
...
local NamesBot = (Redis:get(MEZO.."MEZO:Name:Bot") or "اللورد")
local BotName = {
...
keyboard.inline_keyboard = {
{
{text = NamesBots, url = 't.me/bar_lo0o0o0o0o'}, 
},
{
...
if text == (Redis:get(MEZO.."MEZO:Name:Bot") or "اللورد") then
local photo = LuaTele.getUserProfilePhotos(MEZO)
local ban = LuaTele.getUser(MEZO)
for Name_User in string.gmatch(ban.first_name, "[^%s]+" ) do
ban.first_name = Name_User
...
"سؤال ينرفزك ؟ ", 
" هل يعجبك سورس اللورد؟؟ ", 
" اكثر ممثل تحبه ؟ ", 
"قد تخيلت شي في بالك وصار ؟ ", 
"شيء عندك اهم من الناس ؟ ", 
"تفضّل النقاش الطويل او تحب الاختصار ؟ ", 
"وش أخر شي ضيعته؟ ", 
"اي رايك في سورس اللورد؟ ", 
"كم مره حبيت؟ ", 
...
local CmdStart = '*\n ● أهلآ بك في بوت '..(Redis:get(MEZO.."MEZO:Name:Bot") or "اللورد")..
